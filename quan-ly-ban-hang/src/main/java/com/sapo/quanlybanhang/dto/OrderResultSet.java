...
public class OrderResultSet {
    ...
    public OrderResultSet( String orderCode, Long totalPriceOrder, Long sumDiscount,Long quantityReturnOrder ,Long sellQuantityProduct, Long returnMoney, Long returnQuanlityProduct ) {
        this.totalPriceOrder = totalPriceOrder;
        this.sumDiscount = sumDiscount;
        this.sellQuantityProduct = sellQuantityProduct;
