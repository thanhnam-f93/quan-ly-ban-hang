...
CREATE TABLE `customers` (
  ...
  `date_create` date DEFAULT NULL,
  `create_by_modify` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `date_update` date DEFAULT NULL,
  `create_modify_update` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `order` (
  ...
  `order_staff` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `order` VALUES (1,'#QL',1,1,'Nguyễn Văn a','2021-02-02'),(2,'#QL2',1,1,'Nguyễn Văn a','2021-02-02'),(3,'#QL3',1,2,'Nguyễn Văn B','2021-02-02'),(4,'#QL4',14,2,'Nguyễn Văn B','2021-02-02');
...
INSERT INTO `products` VALUES (1,'#A','Áo khoác Chino thời thượng SID56708',1,100,0,'aa',500.000,1,'chất vải mát',1,'2021-02-02','2021-02-02',1,1),(2,'#A1','Áo khoác đầm dáng xòe nút bọc 2in1',1,100,0,'aaa',600.000,1,'chất vải mát',2,'2021-02-02','2021-02-02',2,1),(3,'#V','Váy phối sọc cá tính SID62366',2,100,0,'bbbb',300.000,2,'váy ngắn mát',5,'2021-02-02','2021-02-02',2,2),(4,'#V2','Váy phối sọc cá tính SID62366',2,100,0,'vvvv',250.000,2,'váy đầm',4,'2021-02-02','2021-02-02',1,2),(5,'#AT','Áo thun phối sọc cá tính SID62366',3,100,0,'ttt',250.000,3,'áo thun coton',5,'2021-02-02','2021-02-02',3,3),(6,'#AT1','Áo thun phối sọc cá tính SID62366',4,100,0,'tttt',300.000,3,'áo thun dáng xuông',4,'2021-02-02','2021-02-02',3,4);
...
CREATE TABLE `staff` (
  ...
  `create_date` date DEFAULT NULL,
  `create_by` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `modify_by` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staff` VALUES (1,'Nguyễn Văn a','12345678','Hà Nội','A@gmail.com',123652458,'2000-02-02','làm việc','2121-02-02','Admin','Admin'),(2,'Nguyễn Văn B','12345678','Hà Nội','B@gmail.com',87654321,'2000-02-02','làm việc','2021-02-02','Admin','Admin'),(3,'Admin','admin','Hà Nội','admin@gmail.com',123,'2000-02-02','chủ','2020-02-02','Admin','Admin');
...
-- Dump completed on 2021-06-24 10:00:27
